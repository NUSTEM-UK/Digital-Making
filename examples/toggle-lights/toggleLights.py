...
# This function takes three values of 0 or 1 and sets the NeoPixels
def theFloorShow(r,g,b):
    for pixel in range(8):
        set_pixel(pixel,r*255,g*255,b*255)
        show()

# We need 3 switches - red, blue and green that give 0/1 (on or off) for each colour
...
# check the worksheet for information about pull-up resistors
blueB = DigitalInputDevice(2, pull_up=True)
redB = DigitalInputDevice(3, pull_up=True)

# This loop will run the program
while True:
